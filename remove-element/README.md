<h2>27. Remove Element</h2><h3>Easy</h3><hr><div><p>Given an array <em>nums</em> and a value <code>val</code>, remove all instances of that value <a href="https://en.wikipedia.org/wiki/In-place_algorithm" target="_blank" class="ah_check_tooltip"><strong>in-place</strong></a> and return the new length.</p>

<p>Do not allocate extra space for another array, you must do this by <strong>modifying the input array <a href="https://en.wikipedia.org/wiki/In-place_algorithm" target="_blank" class="ah_check_tooltip">in-place</a></strong> with <code>O(1)</code> extra memory.</p>
