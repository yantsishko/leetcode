<h2>28. Implement strStr()</h2><h3>Easy</h3><hr><div><p>Implement <a href="http://www.cplusplus.com/reference/cstring/strstr/" target="_blank" class="ah_check_tooltip">strStr()</a>.</p>
